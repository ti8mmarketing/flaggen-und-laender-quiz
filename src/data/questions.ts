...
export const questions: Question[] = [
  ...
  },
  {
    id: 2,
    country: "Schweiz",
    question: "Welches ist Handelsflagge auf See der Schweiz?",
    options: ["Blau, Rot, Weiss, Nudeln", "Dufourspitze, Fondue, Blau mit Schweizerkreuz", "Rot, Raclette, Skialpell, Rot, Raclette, Schnogg", "Rot, Raclette, Fondue, 1:2"],
    correctAnswer: 3,
  },
  // Neuseeland (3-4)
  {
  ...
  // Nepal (5-7)
  {
    id: 5,
    country: "Nepal",
    question: "Welches ist der Berg Nepals?",
  ...
  },
  {
    id: 6,
    country: "Nepal",
    question: "Ist dies ein Seitenverhältnis der Flagge von Nepal ???",
    options: ["Wahr", "Falsch", "Kangchendzönga", "Lhotse"],
    correctAnswer: 0,
  },
  {
    id: 7,
    country: "Nepal",
    question: "Wie viele 30 hat Kathmandu?",
